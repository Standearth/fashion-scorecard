import{S as Z,i as J,s as Q,e as c,k as S,w as I,t as O,G as X,c as p,d as i,m as E,x as T,a as _,h as U,b as r,I as d,g as u,y as P,q as M,o as H,B as R,O as K,l as j,P as Y,E as ee}from"../chunks/index-a1c1e99b.js";import{H as ne,C as te,R as ae,a as ie}from"../chunks/Header-20146ab6.js";import"../chunks/paths-396f020f.js";const oe="Fashion\u2019s Fossil Fuel Problem",se=`<p>From the carbon-intensive energy used to power the processing of its materials and manufacturing of garments, shoes and other goods, to the raw materials such as plastic fibers used to make its products, the industry\u2019s addiction to fossil fuels is at the core of its environmental sustainability problem. </p>\r
\r
\r
...
<li>Public support for government policies to reduce shipping-related pollution, discourage the switch to liquified natural gas (LNG) fuel, and support the deployment of ZEV vessels and port infrastructure.</li></ul>`;var q={"1":[],"2":[],"3":[],"4":[],"5":[],"6":[],"7":[],kf1_title:oe,kf1_intro:se,kf1_body_1:re,kf1_body_2:le,kf1_body_3:ce,kf1_notes:pe,kf2_title:de,kf2_body_1:he,kf2_body_2:ue,kf2_body_3:me,kf2_notes:ge,kf3_title:fe,kf3_body_1:ye,kf3_notes:be,kf4_title:we,kf4_body_1:ve,kf4_notes:ke,kf5_title:_e,kf5_body_1:Ae,kf5_notes:Ce,kf6_title:Ge,kf6_body_1:Fe,methodology_title:xe,methodology_body_1:Se};function Ee(m){let t,o=q.methodology_body_1+"",e;return{c(){t=new K,e=j(),this.h()},l(a){t=Y(a),e=j(),this.h()},h(){t.a=e},m(a,l){t.m(o,a,l),u(a,e,l)},p:ee,d(a){a&&i(e),a&&t.d()}}}function Ie(m){let t,o;return t=new ie({props:{sm:"12",lg:{size:8,offset:2},$$slots:{default:[Ee]},$$scope:{ctx:m}}}),{c(){I(t.$$.fragment)},l(e){T(t.$$.fragment,e)},m(e,a){P(t,e,a),o=!0},p(e,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:e}),t.$set(l)},i(e){o||(M(t.$$.fragment,e),o=!0)},o(e){H(t.$$.fragment,e),o=!1},d(e){R(t,e)}}}function Te(m){let t,o;return t=new ae({props:{$$slots:{default:[Ie]},$$scope:{ctx:m}}}),{c(){I(t.$$.fragment)},l(e){T(t.$$.fragment,e)},m(e,a){P(t,e,a),o=!0},p(e,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:e}),t.$set(l)},i(e){o||(M(t.$$.fragment,e),o=!0)},o(e){H(t.$$.fragment,e),o=!1},d(e){R(t,e)}}}function Pe(m){let t,o,e,a,l,g,C,f,w,$,G,y,v,k,N=q.methodology_title+"",V,F,b,h,x;return g=new ne({props:{headerColor:"blue"}}),h=new te({props:{$$slots:{default:[Te]},$$scope:{ctx:m}}}),{c(){t=c("meta"),o=c("meta"),e=c("meta"),a=c("meta"),l=S(),I(g.$$.fragment),C=S(),f=c("div"),w=c("span"),$=O("Fossil-free Fashion Scorecard"),G=S(),y=c("div"),v=c("div"),k=c("h1"),V=O(N),F=S(),b=c("div"),I(h.$$.fragment),this.h()},l(n){const s=X('[data-svelte="svelte-bh1oxh"]',document.head);t=p(s,"META",{name:!0,content:!0}),o=p(s,"META",{property:!0,content:!0}),e=p(s,"META",{property:!0,content:!0}),a=p(s,"META",{name:!0,content:!0}),s.forEach(i),l=E(n),T(g.$$.fragment,n),C=E(n),f=p(n,"DIV",{class:!0});var A=_(f);w=p(A,"SPAN",{class:!0});var B=_(w);$=U(B,"Fossil-free Fashion Scorecard"),B.forEach(i),A.forEach(i),G=E(n),y=p(n,"DIV",{class:!0});var z=_(y);v=p(z,"DIV",{class:!0});var W=_(v);k=p(W,"H1",{class:!0});var L=_(k);V=U(L,N),L.forEach(i),W.forEach(i),z.forEach(i),F=E(n),b=p(n,"DIV",{class:!0});var D=_(b);T(h.$$.fragment,D),D.forEach(i),this.h()},h(){r(t,"name","title"),r(t,"content","Methodology | Fossil-free Fashion Scorecard | Stand.earth"),r(o,"property","og:title"),r(o,"content","Fossil-free Fashion Scorecard | Stand.earth"),r(e,"property","og:description"),r(e,"content","As one of the biggest drivers of climate pollution, fashion companies must move decisively to break their dependence on fossil fuels, spurring the rapid transition to renewable energy and fossil free fabrics we need to safeguard a livable future."),r(a,"name","description"),r(a,"content","As one of the biggest drivers of climate pollution, fashion companies must move decisively to break their dependence on fossil fuels, spurring the rapid transition to renewable energy and fossil free fabrics we need to safeguard a livable future."),r(w,"class","svelte-1nv3py4"),r(f,"class","banner svelte-1nv3py4"),r(k,"class","svelte-1nv3py4"),r(v,"class","overlay svelte-1nv3py4"),r(y,"class","cover svelte-1nv3py4"),r(b,"class","content svelte-1nv3py4")},m(n,s){d(document.head,t),d(document.head,o),d(document.head,e),d(document.head,a),u(n,l,s),P(g,n,s),u(n,C,s),u(n,f,s),d(f,w),d(w,$),u(n,G,s),u(n,y,s),d(y,v),d(v,k),d(k,V),u(n,F,s),u(n,b,s),P(h,b,null),x=!0},p(n,[s]){const A={};s&1&&(A.$$scope={dirty:s,ctx:n}),h.$set(A)},i(n){x||(M(g.$$.fragment,n),M(h.$$.fragment,n),x=!0)},o(n){H(g.$$.fragment,n),H(h.$$.fragment,n),x=!1},d(n){i(t),i(o),i(e),i(a),n&&i(l),R(g,n),n&&i(C),n&&i(f),n&&i(G),n&&i(y),n&&i(F),n&&i(b),R(h)}}}class $e extends Z{constructor(t){super();J(this,t,null,Pe,Q,{})}}export{$e as default};
