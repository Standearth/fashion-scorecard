    ...
    routes: [
      {
        ...
        params: null,
        path: "/",
        shadow: () => Promise.resolve().then(() => __toESM(require("./entries/endpoints/index.json.js"))),
        a: [0, 2],
        b: [1]
      },
      {
      ...
      },
      {
        ...
        params: (m) => ({ finding: m[1] }),
        load: () => Promise.resolve().then(() => __toESM(require("./entries/endpoints/key-findings/_finding_.json.js")))
      },
      {
        type: "page",
      ...
      },
      {
        ...
        pattern: /^\/([^/]+?)\.json$/,
        params: (m) => ({ brand: m[1] }),
        load: () => Promise.resolve().then(() => __toESM(require("./entries/endpoints/_brand_.json.js")))
      },
      {
        type: "page",
        pattern: /^\/([^/]+?)\/?$/,
